...
export default function DonorCard({
  ...
  return (
    <div
      ...
      className="relative bg-white rounded-[--radius-card] shadow-lg hover:shadow-2xl hover:scale-[1.04] transition-all duration-200 active:scale-[0.97] overflow-hidden cursor-pointer"
    >
      ...
      <div className="p-5">
        ...
        <div className="rounded-xl bg-primary/8 border border-primary/15 px-4 py-3 mb-3">
